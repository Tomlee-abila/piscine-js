...
const cartTotal = obj => mapValues(filterKeys(nutritionDB, (key, value) => obj[key] !== undefined), ([key, value]) => mapValues(value, ([key2, value2])=> Number(parseFloat(value2*(obj[key]/100)).toFixed(4))))
// const nutritionDB = {
